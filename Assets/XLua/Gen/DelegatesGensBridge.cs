...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public UnityEngine.Vector3 __Gen_Delegate_Imp0(float p0, float p1, float p2)
		{
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(GetVector3DDelegate))
			{
			    return new GetVector3DDelegate(__Gen_Delegate_Imp0);
			}
