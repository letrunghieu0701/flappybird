...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp0(UnityEngine.Collision2D p0)
		{
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(OnCollisionEnter2DDelegate))
			{
			    return new OnCollisionEnter2DDelegate(__Gen_Delegate_Imp0);
			}
