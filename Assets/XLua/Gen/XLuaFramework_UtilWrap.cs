...
namespace XLua.CSObjectWrap
{
    ...
    public class XLuaFrameworkUtilWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 28, 2, 0);
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "FindMaterial", _m_FindMaterial_xlua_st_);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new XLuaFramework.Util();
		    ...
		    try {
                ...
                
                {
                    object _o = translator.GetObject(L, 1, typeof(object));
                        ...
                        var gen_ret = XLuaFramework.Util.Int( _o );
		    ...
		    try {
                ...
                
                {
                    object _o = translator.GetObject(L, 1, typeof(object));
                        ...
                        var gen_ret = XLuaFramework.Util.Float( _o );
		    ...
		    try {
                ...
                
                {
                    object _o = translator.GetObject(L, 1, typeof(object));
                        ...
                        var gen_ret = XLuaFramework.Util.Long( _o );
		    ...
		    try {
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 1)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    int _max = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = XLuaFramework.Util.Random( _min, _max );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _uid = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = XLuaFramework.Util.Uid( _uid );
        ...
        static int _m_GetTime_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = XLuaFramework.Util.GetTime(  );
                        LuaAPI.lua_pushint64(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.GameObject>(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _subnode = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = XLuaFramework.Util.Child( _go, _subnode );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.GameObject>(L, 1)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _subnode = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = XLuaFramework.Util.Peer( _go, _subnode );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _source = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = XLuaFramework.Util.md5( _source );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _file = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = XLuaFramework.Util.md5file( _file );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = XLuaFramework.Util.GetFileText( _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _inFile = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = XLuaFramework.Util.GetFileBytes( _inFile );
                        LuaAPI.lua_pushstring(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    string _separate = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = XLuaFramework.Util.GetFileNamesInFolder( _path, _separate );
                        LuaAPI.lua_pushstring(L, gen_ret);
                ...
                if(gen_param_count == 1&& (LuaAPI.lua_isnil(L, 1) || LuaAPI.lua_type(L, 1) == LuaTypes.LUA_TSTRING)) 
                {
                    string _path = LuaAPI.lua_tostring(L, 1);
                        ...
                        var gen_ret = XLuaFramework.Util.GetFileNamesInFolder( _path );
                        LuaAPI.lua_pushstring(L, gen_ret);
        ...
        static int _m_CheckEnvironment_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = XLuaFramework.Util.CheckEnvironment(  );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.GameObject _prefab = (UnityEngine.GameObject)translator.GetObject(L, 1, typeof(UnityEngine.GameObject));
                        ...
                        var gen_ret = XLuaFramework.Util.InstantiateObject( _prefab );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ushort _n = (ushort)LuaAPI.xlua_tointeger(L, 1);
                        ...
                        var gen_ret = XLuaFramework.Util.SwapUInt16( _n );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    short _n = (short)LuaAPI.xlua_tointeger(L, 1);
                        ...
                        var gen_ret = XLuaFramework.Util.SwapInt16( _n );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _n = LuaAPI.xlua_tointeger(L, 1);
                        ...
                        var gen_ret = XLuaFramework.Util.SwapInt32( _n );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    uint _n = LuaAPI.xlua_touint(L, 1);
                        ...
                        var gen_ret = XLuaFramework.Util.SwapUInt32( _n );
		    ...
		    try {
                ...
                
                {
                    long _n = LuaAPI.lua_toint64(L, 1);
                        ...
                        var gen_ret = XLuaFramework.Util.SwapInt64( _n );
                        LuaAPI.lua_pushint64(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ulong _n = LuaAPI.lua_touint64(L, 1);
                        ...
                        var gen_ret = XLuaFramework.Util.SwapUInt64( _n );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_FindMaterial_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    string _materialName = LuaAPI.lua_tostring(L, 2);
                    
                        var gen_ret = XLuaFramework.Util.FindMaterial( _materials, _materialName );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
